...
//----------------------------------长按------------------------------------------------------------
    /**
     * 长按。根据控件的text属性找到指定的控件执行长按操作。注意：这里text是包含而不是绝对匹配，所以只有根据text属性能唯一匹配的时候才用此方法
     *
     * @param context UiControlAccessibilityService类型的context
     * @param text       控件的text属性
     * @param level 操作对象节点的层级（相对于找到的匹配节点），比如：0-匹配节点自身；1-匹配节点的父节点；2-匹配节点的爷爷节点；-1-匹配节点的子节点。
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByText(UiControlAccessibilityService context, String text, int level) {
        AccessibilityNodeInfo node = findNodeByText(context, text);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
                    ...
                    break;
                case ConfigTest.NODE_FATHER:  //匹配节点的父节点
                    node.getParent().performAction(AccessibilityNodeInfo.ACTION_LONG_CLICK);
                    break;
                case ConfigTest.NODE_GRANDFATHER:  //匹配节点的爷爷节点
                    node.getParent().getParent().performAction(AccessibilityNodeInfo.ACTION_LONG_CLICK);
                    break;
                case ConfigTest.NODE_SON:  //匹配节点的子节点
                    //TODO
                    break;
    ...
    /**
     * 长按。根据控件的resource-id属性找到指定的控件执行长按操作。注意：只有根据resource-id属性能唯一匹配的时候才用此方法
     *
     * @param context UiControlAccessibilityService类型的context
     * @param resourceid 控件的resource-id属性
     * @param level 操作对象节点的层级（相对于找到的匹配节点），比如：0-匹配节点自身；1-匹配节点的父节点；2-匹配节点的爷爷节点；-1-匹配节点的子节点。
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickById(UiControlAccessibilityService context, String resourceid, int level) {
        AccessibilityNodeInfo node = findNodeById(context, resourceid);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的resource-id和text属性找到指定的控件执行长按操作。text绝对匹配。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param resourceid 控件的resource-id属性
     * @param text       控件的text属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByIdAndText(UiControlAccessibilityService context, String resourceid, String text, int level) {
        AccessibilityNodeInfo node = findNodeByIdAndText(context, resourceid, text);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的resource-id和text属性找到指定的控件执行长按操作。text包含，非绝对匹配。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param resourceid 控件的resource-id属性
     * @param text       控件的text属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByIdAndTextContain(UiControlAccessibilityService context, String resourceid, String text, int level) {
        AccessibilityNodeInfo node = findNodeByIdAndTextContain(context, resourceid, text);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的text和resource-id属性找到指定的控件执行长按操作。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param text       控件的text属性
     * @param resourceid 控件的resource-id属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByTextAndId(UiControlAccessibilityService context, String text, String resourceid, int level) {
        AccessibilityNodeInfo node = findNodeByTextAndId(context, text, resourceid);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的text和class属性找到指定的控件执行长按操作。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param text       控件的text属性
     * @param className 控件的class属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByTextAndClass(UiControlAccessibilityService context, String text, String className, int level) {
        AccessibilityNodeInfo node = findNodeByTextAndClass(context, text, className);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的text和package属性找到指定的控件执行长按操作。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param text       控件的text属性
     * @param packageName 控件的package属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByTextAndPackage(UiControlAccessibilityService context, String text, String packageName, int level) {
        AccessibilityNodeInfo node = findNodeByTextAndPackage(context, text, packageName);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的text和content-desc属性找到指定的控件执行长按操作。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param text       控件的text属性
     * @param contentDesc 控件的content-desc属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByTextAndContentDesc(UiControlAccessibilityService context, String text, String contentDesc, int level) {
        AccessibilityNodeInfo node = findNodeByTextAndContentDesc(context, text, contentDesc);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的resource-id和class属性找到指定的控件执行长按操作。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param resourceid 控件的resource-id属性
     * @param className       控件的class属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByIdAndClass(UiControlAccessibilityService context, String resourceid, String className, int level) {
        AccessibilityNodeInfo node = findNodeByIdAndClass(context, resourceid, className);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的resource-id和package属性找到指定的控件执行长按操作。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param resourceid 控件的resource-id属性
     * @param packageName       控件的package属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByIdAndPackage(UiControlAccessibilityService context, String resourceid, String packageName, int level) {
        AccessibilityNodeInfo node = findNodeByIdAndPackage(context, resourceid, packageName);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的resource-id和content-desc属性找到指定的控件执行长按操作。content-desc绝对匹配。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param resourceid 控件的resource-id属性
     * @param contentDesc       控件的content-desc属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByIdAndContentDesc(UiControlAccessibilityService context, String resourceid, String contentDesc, int level) {
        AccessibilityNodeInfo node = findNodeByIdAndContentDesc(context, resourceid, contentDesc);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的resource-id和content-desc属性找到指定的控件执行长按操作。content-desc包含，非绝对匹配。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param resourceid 控件的resource-id属性
     * @param contentDesc       控件的content-desc属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByIdAndContentDescContain(UiControlAccessibilityService context, String resourceid, String contentDesc, int level) {
        AccessibilityNodeInfo node = findNodeByIdAndContentDescContain(context, resourceid, contentDesc);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的text、resource-id和class属性找到指定的控件执行长按操作。
     *
     * @param context UiControlAccessibilityService类型的context
     * @param text 控件的text属性
     * @param resourceid 控件的resource-id属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByTextAndIdAndClass(UiControlAccessibilityService context, String text, String resourceid, String className, int level) {
        AccessibilityNodeInfo node = findNodeByTextAndIdAndClass(context,text, resourceid, className);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
    ...
    /**
     * 长按。根据控件的全部常用属性找到指定的控件执行长按操作。常用属性：text、resource-id、class、package。
     * content-desc由于经常为空，所以不进行匹配
     *
     * @param context UiControlAccessibilityService类型的context
     * @param text 控件的text属性
     ...
     * @return true：执行成功；false：未找到控件，执行失败
     */
    public static boolean findAndPerformLongClickByFullInfo(UiControlAccessibilityService context, String text, String resourceid, String className, String packageName, int level) {
        AccessibilityNodeInfo node = findNodeByFullInfo(context,text, resourceid, className, packageName);
        if (node != null) {
            switch (level) {
                case ConfigTest.NODE_SELF:  //匹配节点自身
